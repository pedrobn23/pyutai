...
def total_size(o, handlers={}, verbose=False):
    ...
    def sizeof(o):
        ...
        for typ, handler in all_handlers.items():
            ...
            if not hasattr(o.__class__, '__slots__'): # no __slots__ *usually* means a __dict__,
                if hasattr(o, '__dict__'): # some special builtin classes (such as `type(None)`) have neither
                    s+=sizeof(o.__dict__) 
